...
function ThemeToggle() {
    ...
    return (
        <button
            ...
            aria-pressed={dark}
            className="-m-1 inline-flex h-11 w-11 items-center justify-center rounded-lg text-[var(--rd-text-3)] transition-colors hover:bg-[var(--rd-surface-2)] hover:text-[var(--rd-text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--rd-orange)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--rd-bg-sub)]"
        >
            {dark ? (
                <svg
                    width="17"
        ...
        >
            <div className="flex items-center gap-4 sm:gap-6">
                ...
                <a
                    ...
                    className="shrink-0 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--rd-orange)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--rd-bg-sub)]"
                >
                    <Image
                        src="/avatar.png"
                        alt="hovanhoa"
                ...
                <button
                    ...
                    aria-haspopup="menu"
                    aria-expanded={open}
                    className="inline-flex items-center gap-1.5 rounded-full bg-[var(--rd-orange-bg)] px-3 py-1.5 font-[family-name:var(--font-mono)] text-[13px] font-semibold text-[var(--rd-orange-ink)] transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--rd-orange)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--rd-bg-sub)]"
                >
                    <CurrentIcon
                        size={15}
                        className="text-[var(--rd-orange)]"
                    />
                ...
                >
                                        ...
                                        return (
                                            <li key={it.label}>
                                                <a
                                                    ...
                                                    className={`group flex items-center gap-2.5 rounded-[var(--rd-r-sm)] px-2 py-1.5 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-[var(--rd-orange)] ${
                                                        active
                                                            ? 'bg-[var(--rd-orange-bg)]'
                                                    ...
                                                    <Icon
                                                        ...
                                                        className={`shrink-0 ${
                                                            active
                                                                ...
                                                                : 'text-[var(--rd-text-3)] group-hover:text-[var(--rd-orange-ink)]'
                                                        }`}
                                                    />
                                                    <span className="min-w-0">
                                                        <span
                                                            className={`flex items-center gap-1.5 text-[13px] font-medium leading-tight transition-colors ${
                                                                active
                                                                    ? 'text-[var(--rd-orange-ink)]'
                                                                    : 'text-[var(--rd-text)] group-hover:text-[var(--rd-orange-ink)]'
                                                            }`}
                                                        >
                                                            {it.label}
                                                            {active && (
                                                                <span
                                                                    aria-hidden
                                                                    className="h-1.5 w-1.5 rounded-full bg-[var(--rd-orange)]"
                                                                />
                                                            )}
                                                        </span>
                    ...
                    <div className="flex items-center justify-between gap-4 border-t border-[var(--rd-border)] bg-[var(--rd-bg-sub)] px-4 py-2.5">
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 font-[family-name:var(--font-mono)] text-[13px] font-semibold text-[var(--rd-orange-ink)] transition-opacity hover:opacity-80"
                        >
                            browse everything
